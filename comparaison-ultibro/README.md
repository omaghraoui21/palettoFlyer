...
Le contrôle couvre les bilans, entrées impossibles, changement de masse, refus de la voie PI dans le calculateur actuel, plans, scores et conservation des sources. [Résultats enregistrés](VERIFICATIONS.json) et [inventaire avec empreintes](INVENTAIRE_SOURCES.json).
