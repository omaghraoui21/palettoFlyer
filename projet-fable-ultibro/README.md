...
- `presentation/SCRIPT.md` + `presentation/PROMPT_GENERATION.md` — script de 16 diapositives (statuts établi/calculé/hypothèse, flowcharts Mermaid, sources) et prompt pour l'agent qui générera la présentation.
